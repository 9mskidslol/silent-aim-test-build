-- // Dependencies
_G.PRED = 0.015
local Aiming = loadstring(game:HttpGethttps://raw.githubusercontent.com/fedaralagent/silent-aim-test-build/main/preview.lua"))()
Aiming.TeamCheck(false)Aiming.ShowFOV = false
Aiming.FOV = 15
-- // Services
