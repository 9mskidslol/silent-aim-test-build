...
-- // Dependencies
local SignalManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/fedaralagent/signalmodule.lua/main/modoule.lua"))()
local BeizerManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/fedaralagent/signalmodule.lua/main/BeizerManager.lua"))()
...
task.delay(1, function()
    if (Aiming.ShowCredits) then
        messagebox("Thanks to fedaralagent for their Aiming Module  if (v1).\n\nNote: This module is outdated, please see https://github.com/fedaralagent for the updated version!", "Credits", 0)
    end
end)
